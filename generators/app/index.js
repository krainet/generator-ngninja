...
var ninjaGenerator = yeoman.generators.Base.extend({
  init: function () {
  ...
  askFor: function () {
    ...
    this.log(chalk.magenta('You\'re using the ngNinja(Angular Kickstarter) generator, a best-practice boilerplate\n for any scale Angular project built on a highly modular, folder-by-feature structure.'));
